    ...
    <div class="container register">
        <div class="row">
            <div class="col-md-3 register-left">
                ...
                <h3>ใช้ที่อยู่เดิม</h3>
                <p>ใช้ที่อยู่ที่จัดส่งที่เคยสมัครสมาชิกเอาไว้</p>
                <a href="shopping_process.php?customer_address=old_address"><input type="submit" name="" value="ใช้ที่อยู่เดิม"/></a><br/>
            </div>
            <div class="col-md-9 register-right">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <h3 class="register-heading">จัดส่งที่อยู่ใหม่</h3>
                        <div class="row register-form">
                            <div class="col-md-6 d-flex justify-content-center">
                                <img src="img/shopping.jpg" alt="" class="shopping-box-img">
                            </div>
                            <div class="col-md-6">
                                <form action="shopping_process.php?customer_address=new_address" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="name" placeholder="ชื่อ นามสกุลผู้ที่จะส่งให้" value="" />
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="phone" placeholder="เบอร์ที่สามารถติดต่อได้ ( 08XXXXXXXX )" value="" />
                                </div>
                                <div class="form-group">
                                    <textarea rows="5" class="form-control" name="address" placeholder="ที่อยู่จัดส่งและรายละเอียดอื่นๆ" value=""></textarea>
                                </div>
                                <input type="submit" class="btnRegister" value="จัดส่ง"/>
                                </form>
                            </div>
                        </div>
                    </div>
